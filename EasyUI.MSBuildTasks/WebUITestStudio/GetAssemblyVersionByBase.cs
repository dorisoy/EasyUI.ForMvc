namespace EasyUI.MSBuildTasks.WebUITestStudio
{
    ...
    public class GetAssemblyVersionByBase : Task
    {
        ...
        public override bool Execute()
        {
            ...
            string itemSpec = version2.NewVersion.ToString(4);
            if ((this.Separator != null) && (this.Separator.ItemSpec != "."))
            {
                itemSpec = VersionFormatter.Full(version2.NewVersion, this.Separator.ItemSpec);
            }
