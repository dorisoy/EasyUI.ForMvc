    ...
    public class AuthorizeAttributeCacheTests
    {
        ...
        public AuthorizeAttributeCacheTests()
        {
            Func<string, Type> getType = name =>
                                         {
                                             Type t = Type.GetType("EasyUI.Web.Mvc.Infrastructure.Implementation.Tests." + name + "Controller", false, true);
        ...
        {
            controllerTypeCache.Setup(c => c.GetControllerTypes(It.IsAny<RequestContext>(), It.IsAny<string>())).Returns((RequestContext r, string t) => new List<Type>{ Type.GetType("EasyUI.Web.Mvc.Infrastructure.Implementation.Tests.DummyNamespace." + t + "Controller", false, true) });

            RequestContext context = TestHelper.CreateRequestContext();
            context.RouteData.DataTokens.Add("Namespaces", new[] { "EasyUI.Web.Mvc.Infrastructure.Implementation.Tests.DummyNamespace" });
        ...
        public void GetAuthorizeAttributes_should_return_correct_action_attribute_from_area_controller()
        {
            List<Type> list = new List<Type> { 
                typeof(EasyUI.Web.Mvc.Infrastructure.Implementation.Areas.Test1.AreaController),
                typeof(EasyUI.Web.Mvc.Infrastructure.Implementation.Areas.Test1.AreaController)
            };
