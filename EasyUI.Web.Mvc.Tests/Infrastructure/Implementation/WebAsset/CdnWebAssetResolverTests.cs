namespace EasyUI.Web.Mvc.Infrastructure.Implementation.Tests
{
    ...
    public class CdnWebAssetResolverTests
    {
        ...
        public void BaseUrl_should_return_insecure_script_url_if_asset_is_script_file()
        {
            ...
            Assert.Equal(WebAssetDefaultSettings.EasyUIContentDeliveryNetworkScriptUrl, resolver.GetBaseUrl(resolverContext));
        }
        ...
        public void BaseUrl_should_return_secure_script_url_if_asset_is_script_file()
        {
            ...
            Assert.Equal(WebAssetDefaultSettings.EasyUIContentDeliveryNetworkSecureScriptUrl, resolver.GetBaseUrl(resolverContext));
        }
        ...
        public void BaseUrl_should_return_secure_stylesheet_url_if_asset_is_css_file()
        {
            ...
            resolverContext.IsSecureConnection = true;
            Assert.Equal(WebAssetDefaultSettings.EasyUIContentDeliveryNetworkSecureStyleSheetUrl, resolver.GetBaseUrl(resolverContext));
        }
        ...
        {
            resolver = new CdnWebAssetResolver(new WebAsset("foo.css"));
            Assert.Equal(WebAssetDefaultSettings.EasyUIContentDeliveryNetworkStyleSheetUrl, resolver.GetBaseUrl(resolverContext));
        }        
        ...
        public void Should_link_to_cdn()
        {
            ...
            Assert.Equal(WebAssetDefaultSettings.EasyUIContentDeliveryNetworkScriptUrl +
