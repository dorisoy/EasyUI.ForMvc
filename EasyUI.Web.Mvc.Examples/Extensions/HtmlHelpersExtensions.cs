namespace EasyUI.Web.Mvc.Examples
{
    ...
    public static class HtmlHelpersExtensions
    {
        ...
        {
            XmlSiteMap sitemap = (XmlSiteMap)html.ViewData["easyui.mvc.examples"];
        ...
        public static string ProductVersion(this HtmlHelper html)
        {
            ...
            return string.Format("Version Q{0} {1}, released {2:d2}/{3:d2}/{4}", quarter, versionYear, month, day, year);
        }
    ...
    public class ExampleConfigurator : IDisposable
    {
        ...
        {
            string theme = this.htmlHelper.ViewContext.HttpContext.Request.Params["theme"] ?? "Metro";
