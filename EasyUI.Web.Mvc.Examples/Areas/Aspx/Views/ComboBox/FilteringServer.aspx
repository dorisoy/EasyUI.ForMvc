<%@ Page Title="" Language="C#" Inherits="System.Web.Mvc.ViewPage<EasyUI.Web.Mvc.Examples.ComboBoxAjaxFilteringModel>" %>
       ...
       { %>
        <ul>
            ...
            <li>
                ...
                <% Html.EasyUI().IntegerTextBoxFor(m => m.ComboBoxAttributes.MinimumChars)
                ...
                <% Html.EasyUI().IntegerTextBoxFor(m => m.ComboBoxAttributes.Delay)
                                 .InputHtmlAttributes(new { style = "width: 60px" })
                                 .MinValue(0)
                                 .MaxValue(2000)
    ...
    <% using (Html.Configurator("The AutoComplete should...")
       ...
       { %>
            ...
            <li>
                ...
                <%: Html.EasyUI().IntegerTextBoxFor(m => m.AutoCompleteAttributes.MinimumChars)
                                  .InputHtmlAttributes(new { style = "width: 60px" })
                                  .MinValue(1)
                                  .MaxValue(1000)
                %>
                <label for="AutoCompleteAttributes_Delay">chars and</label>
                <%: Html.EasyUI().IntegerTextBoxFor(m => m.AutoCompleteAttributes.Delay)
                                  .InputHtmlAttributes(new { style = "width: 60px" })
                                  .MinValue(0)
                                  .MaxValue(2000)
                %>
