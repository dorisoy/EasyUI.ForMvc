                ...
                .Items(menu =>
                {
                    ...
                    menu.Add()
                        ...
                        .Items(item =>
                        {
                            ...
                            item.Add().Text("... and 28 more!").Url("http://www.easyui.com/products/silverlight.aspx");
                        });
                    ...
                    menu.Add()
                        ...
                        .Items(item =>
                        {
                            ...
                            item.Add().Text("... and 28 more!").Url("http://www.easyui.com/products/aspnet-ajax.aspx");
                    ...
                    menu.Add()
                        ...
                        .Content(() =>
                        {%>
                            <img src="<%: ResolveUrl("~/Content/Common/orm-comparison.png") %>" alt="EasyUI OpenAccess" />
                            <a id="buy" href="http://www.easyui.com/purchase/individual/orm.aspx">
                                EasyUI OpenAccess ORM
                            </a>
                            <a id="express" href="http://www.easyui.com/community/license-agreement.aspx?pId=639">
                                EasyUI OpenAccess ORM Express
                            </a>
                        <%});
