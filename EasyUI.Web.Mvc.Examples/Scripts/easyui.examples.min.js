$(function () {
    ...
    var availableSkins = 'Metro'.split(',');
    ...
    function getThemeGalleryHtml() {
        ...
        themeGalleryHtml.cat('<div id="theme-gallery"><h2>选择皮肤</h2><ul>');

        var url = window.location.href;
        var currentTheme = themeRegex.test(url) ? themeRegex.exec(url)[1] : 'metro';
        ...
        themeGalleryHtml.cat('</ul>')
            .catIf('', currentComponent.toLowerCase() != "chart")
            .cat('</div>');
    ...
    //主题包选择
    $('#theming .t-drop-down').click(function (e) {
            e.preventDefault();
