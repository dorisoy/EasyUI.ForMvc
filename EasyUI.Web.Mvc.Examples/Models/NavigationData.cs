        ...
        public static List<NavigationData> GetCollection()
        {
            return new List<NavigationData>
            {
                new NavigationData
                {
                    ...
                    NavigateUrl = "http://www.easyui.com/products/aspnet-mvc.aspx"
                },
                new NavigationData
                {
                    Text = "Silverlight", 
                    ImageUrl = "~/Content/Common/Icons/Suites/sl.png",
                    NavigateUrl = "http://www.easyui.com/products/silverlight.aspx"
                },
                new NavigationData
                {
                    Text = "ASP.NET AJAX", 
                    ImageUrl = "~/Content/Common/Icons/Suites/ajax.png",
                    NavigateUrl = "http://www.easyui.com/products/aspnet-ajax.aspx"
                },
                new NavigationData
                {
                    Text = "OpenAccess ORM",
                    ImageUrl = "~/Content/Common/Icons/Suites/orm.png",
                    NavigateUrl = "http://www.easyui.com/products/orm.aspx"
                },
                new NavigationData
                {
                    Text = "Reporting", 
                    ImageUrl = "~/Content/Common/Icons/Suites/rep.png",
                    NavigateUrl = "http://www.easyui.com/products/reporting.aspx"
                },
                new NavigationData
                {
                    Text = "Sitefinity ASP.NET CMS", 
                    ImageUrl = "~/Content/Common/Icons/Suites/sitefinity.png",
                    NavigateUrl = "http://www.easyui.com/products/sitefinity.aspx"
                },
                new NavigationData
                {
                    Text = "Web Testing Tools", 
                    ImageUrl = "~/Content/Common/Icons/Suites/test.png",
                    NavigateUrl = "http://www.easyui.com/products/web-testing-tools.aspx"
                }
            };
        }
    }
