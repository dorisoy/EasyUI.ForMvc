...
namespace EasyUI.Web.Mvc.UI
{
    ...
    public class ScriptRegistrarBuilder : ComponentBuilderBase<ScriptRegistrar, ScriptRegistrarBuilder>, IHideObjectMembers
    {
        ...
        /// </summary>
        /// <remarks>
        /// EasyUI Extensions for ASP.NET MVC require jQuery so make sure you manually include the JavaScript file
        ...
        /// </summary>
        /// <remarks>
        /// EasyUI Extensions for ASP.NET MVC use jQuery validation
        /// </remarks>
        /// <param name="enable">if set to <c>true</c> [enable].</param>
        /// <example>
        /// <code lang="CS">
