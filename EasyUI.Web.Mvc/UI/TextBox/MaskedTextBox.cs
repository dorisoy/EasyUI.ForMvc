...
namespace EasyUI.Web.Mvc.UI
{
    ...
    public class MaskedTextBox : TextBoxBase<double>
    {
        public MaskedTextBox(ViewContext viewContext, IClientSideObjectWriterFactory clientSideObjectWriterFactory, ITextBoxBaseHtmlBuilderFactory<double> rendererFactory)
