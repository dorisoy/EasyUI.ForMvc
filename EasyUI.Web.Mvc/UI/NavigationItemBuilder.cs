...
namespace EasyUI.Web.Mvc.UI
{
    ...
    public abstract class NavigationItemBuilder<TItem, TBuilder> where TItem : NavigationItem<TItem> where TBuilder : NavigationItemBuilder<TItem, TBuilder>, IHideObjectMembers
    {
        ...
        public TBuilder ShowDescription(bool value)
        {
            item.ShowDescription = value;
            return this as TBuilder;
        }

        public TBuilder UseDefaultClassStyle(bool value)
        {
            item.UseDefaultClassStyle = value;
            return this as TBuilder;
        }
        ...
        public TBuilder IconFix(string value)
        {
            Guard.IsNotNullOrEmpty(value, "value");
