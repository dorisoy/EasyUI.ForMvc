...
namespace EasyUI.Web.Mvc.UI.Input
{
    ...
    public class InputRadioBox<T> : InputBoxBase<T> where T : struct
    {
        public InputRadioBox(ViewContext viewContext, IClientSideObjectWriterFactory clientSideObjectWriterFactory, IInputBoxBaseHtmlBuilderFactory<T> rendererFactory)
