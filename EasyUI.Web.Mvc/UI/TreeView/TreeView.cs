...
namespace EasyUI.Web.Mvc.UI
{
    ...
    /// <summary>
    /// EasyUI Treeview for ASP.NET MVC is a view component for presenting hierarchical data.
    /// </summary>
    public class TreeView : ViewComponentBase, INavigationItemComponent<TreeViewItem>, IEffectEnabled
    {
            ...
            : base(viewContext, clientSideObjectWriterFactory)
        {
            ...
            ScriptFileNames.AddRange(new[] { "easyui.common.js", "easyui.treeview.js" });
        ...
        protected override void WriteHtml(HtmlTextWriter writer)
        {
            ...
            if (DragAndDrop.Enabled)
            {
                ScriptFileNames.Insert(1, "EasyUI.draganddrop.js");
            }
