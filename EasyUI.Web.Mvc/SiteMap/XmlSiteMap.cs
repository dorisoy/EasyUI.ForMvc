...
namespace EasyUI.Web.Mvc
{
    ...
    public class XmlSiteMap : SiteMapBase
    {
        ...
        private const string IcoStyleAttributeName = "icostyle";
        ...
        private static void PopulateNode(SiteMapNode siteMapNode, XmlNode xmlNode)
        {
            ...
            siteMapNode.IcoStyle = GetStringValueFromAttribute(xmlNode, IcoStyleAttributeName);
            siteMapNode.Description = GetStringValueFromAttribute(xmlNode, DescriptionAttributeName);
