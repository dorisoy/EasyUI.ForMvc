...
namespace EasyUI.Web.Mvc
{
    ...
    public class SiteMapNodeBuilder : IHideObjectMembers
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="EasyUI.Web.Mvc.SiteMapNodeBuilder"/> to <see cref="EasyUI.Web.Mvc.SiteMapNode"/>.
        /// </summary>
        ...
        private void SetDescriptionIfEmpty(string value)
        {
            if (string.IsNullOrEmpty(siteMapNode.Description))
            {
                siteMapNode.Description = value;
            }
        }

        private void SetIcoStyleIfEmpty(string value)
        {
            if (string.IsNullOrEmpty(siteMapNode.IcoStyle))
            {
                siteMapNode.IcoStyle = value;
            }
        }
    }
}