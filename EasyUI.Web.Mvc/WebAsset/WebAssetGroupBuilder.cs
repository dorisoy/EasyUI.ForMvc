...
namespace EasyUI.Web.Mvc.UI
{
    ...
    public class WebAssetGroupBuilder : IHideObjectMembers
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="EasyUI.Web.Mvc.UI.WebAssetGroupBuilder"/> to <see cref="EasyUI.Web.Mvc.UI.WebAssetGroup"/>.
        /// </summary>
        ...
        /// <summary>
        /// Sets whether EasyUI content delivery network would be used.
        /// </summary>
        /// <param name="value">if set to <c>true</c> [value].</param>
        /// <returns></returns>
        public virtual WebAssetGroupBuilder UseEasyUIContentDeliveryNetwork(bool value)
        {
            assetItemGroup.UseEasyUIContentDeliveryNetwork = value;
