...
namespace EasyUI.Web.Mvc.UI
{
    ...
    public class WebAssetCollectionBuilder : IHideObjectMembers
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="EasyUI.Web.Mvc.UI.WebAssetCollectionBuilder"/> to <see cref="EasyUI.Web.Mvc.UI.WebAssetCollection"/>.
        /// </summary>
                ...
                WebAssetGroup localGroup = new WebAssetGroup(group.Name, true)
                                                   {
                                                       ...
                                                       UseEasyUIContentDeliveryNetwork = group.UseEasyUIContentDeliveryNetwork,
