...
(function ($) {
    ...
    var $t = $.easyui = {
        ...
        cultureInfo: {
            ...
            abbrMonths: ['一', '二', '三', '四', '五', '六', '七', '八', '九', '十', '十一', '十二'],
            longTime: 'h:mm:ss tt',
    ...
    function resolve(dependencies, callback) {
        ...
        dependencies = $.grep(dependencies, function (dependency) {
            ...
            if (dependency.indexOf("jquery-") > -1 || (dependency.indexOf("jquery.validate") > -1 && $.fn.validate) || dependency.indexOf("easyui.common") > -1) {
                return false;
            }
    ...
    $.easyui.template = $.proxy(Template.compile, Template);
    $.easyui.htmlEncode = htmlEncode;
